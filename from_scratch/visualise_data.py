...
for file in os.listdir("from_scratch/accuracies"):
    slope=float(file[0]+"."+file[1:])
    with open(f"from_scratch/accuracies/{file}","rb") as accuracy_file:
...
plt.savefig("from_scratch/accuracies.png",bbox_inches="tight")
